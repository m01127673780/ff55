...
$(document).ready(function(){
  ...
  $('#jstree').jstree({
    "core" : {
      'data' : {!! load_dep($productAdmin->department_id) !!},
      "themes" : {
        "variant" : "large"
      }
    },
...
<div class="box">
    ...
    'product_name_ar',
      ...
      'photo',
       ...
       'department_id', -->
    <div class="box-body">
        {!! Form::open(['url'=>aurl('productsAdmin'),'files'=>true]) !!}
        <div class="form-group">
            {!! Form::label('product_name_ar',trans('admin.product_name_ar')) !!}
            {!! Form::text('product_name_ar',$productAdmin->product_name_ar,['class'=>'form-control']) !!}
        </div>
       

         <div class="form-group">
            {!! Form::label('desc_ar',trans('admin.desc_ar')) !!}
            {!! Form::text('desc_ar',$productAdmin->desc_ar,['class'=>'form-control']) !!}
        </div>
<!-- 
         <div class="form-group">
            {!! Form::label('desc_en',trans('admin.desc_en')) !!}
            {!! Form::text('desc_en',$productAdmin->desc_en,['class'=>'form-control']) !!}
        </div> -->
         ...
         <div class="form-group">
            ...
            {!! Form::text('nun_sms',$productAdmin->nun_sms ,['class'=>'form-control']) !!}
        </div>  
          <div class="form-group">
            {!! Form::label('num_member',trans('admin.num_member')) !!}
            {!! Form::text('num_member',$productAdmin->num_member ,['class'=>'form-control']) !!}
        </div> 
        <div class="form-group">
            {!! Form::label('date_month',trans('admin.date_month')) !!}
            {!! Form::text('date_month',$productAdmin->date_month ,['class'=>'form-control']) !!}
        </div>
