...
<div class="box">
  ...
  <div class="box-body">
    ...
    <a href="departments/create" class="btn btn-info  showbtn_control hidden" ><i class="fa fa-plus"></i> {{ trans('admin.add') }}</a>

<a href="" class="btn btn-success edit_dep showbtn_control hidden" ><i class="fa fa-edit"></i> {{ trans('admin.edit') }}</a>
...
{{-- <a href="departments/create" class="btn btn-danger delete_dep showbtn_control hidden"  data-toggle="modal"   ><i class="fa fa-plus"></i> {{ trans('admin.add') }}</a>
 --}}
