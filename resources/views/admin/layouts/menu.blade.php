...
<img  class ="img_flag"src="https://www.worldatlas.com/r/w480/img/flag/eg-flag.jpg" >
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="{{Storage::url(admin()->user()->icon)}}" class="user-image" alt="User Image">

               <span class="hidden-xs">{{ admin()->user()->name }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header" style="padding-bottom: 200px">
                   <p>  
                  <img src="{{Storage::url(admin()->user()->icon)}}"  class="user-image-larg" alt="User Image">
               <p>
               ...
               <li class="user-footer">
                <div class="pull-left">
                 <a href="{{ aurl('edit/profile') }}" class="btn btn-info"><i class="fa fa-edit fa-spin"></i>
