...
class ProductsAdminDatatable extends DataTable
{
   /**
   ...
   public function dataTable($query)
   {
      return datatables($query)
         ->addColumn('checkbox', 'admin.productsAdmin.btn.checkbox')
         ->addColumn('edit', 'admin.productsAdmin.btn.edit')
         ->addColumn('delete', 'admin.productsAdmin.btn.delete')
         ->rawColumns([
            'edit',
            'delete',
             'checkbox',
...
public function query() {
    return ProductAdmin::query()->with('department_id')->select('productsAdmin.*');
  }
   /**
   ...
   {
      return 'productsAdmin_' . date('YmdHis');
   }
}
